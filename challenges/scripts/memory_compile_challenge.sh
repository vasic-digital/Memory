#!/usr/bin/env bash
# memory_compile_challenge.sh - Validates Memory module compilation and code quality
set -euo pipefail
...
echo "Test: Module name is digital.vasic.memory"
if grep -q "^module digital.vasic.memory$" "${MODULE_DIR}/go.mod"; then
    pass "Module name is digital.vasic.memory"
else
