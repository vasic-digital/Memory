# Memory - Generic, reusable Go module for memory management with Mem0-style capabilities, entity extraction, and knowledge graph construction.
...
challenge:
	../challenges/scripts/memory_challenge.sh 2>/dev/null || echo "No challenge script"

help:
	@echo "Memory - Generic, reusable Go module for memory management with Mem0-style capabilities, entity extraction, and knowledge graph construction."
	@echo ""
	@echo "Build & Test:"
